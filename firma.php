...
<body>
                    ...
                    <div class="sepcon">
                        ...
                        <div>
                            <div class="cargo_descripcion">
                                ...
                                <p><b id="nombre_encargado"></b></p>
                                <canvas id="firma__encargado" width="340" height="200" class="oculto">
                            ...
                            <div class="cargo_descripcion">
                                ...
                                <p><b id="nombre_jefatura"></b></p>
                                <canvas id="firma__jefatura" width="340" height="200" class="oculto">
                                    No tienes un buen navegador.
                                </canvas>
                                <img src="" alt="" id="img_jefatura" class="firmas">
                            </div>
                            <div class="cargo_descripcion">
                                <h5>SUPERVISION DEL CLIENTE</h5>
                                <p><b id="nombre_supervision"></b></p>
                                <span id="firmado" class="oculto">0</span>
                                <canvas id="firma__supervision" width="340" height="200" class="oculto">
                                    No tienes un buen navegador.
                                </canvas>
                                <img src="" alt="" id="img_supervision" class="firmas oculto" >
                            </div>
                        </div>
                    </div>
                    <div class="controles oculto">
				        <input type="button" class="button" id="draw-clearBtn" value="Limpiar Firma"></input>
                        <!--<input type="button" class="button" id="draw-submitBtn oculto" value="Grabar Firma"></input>-->
    ...
    <div class="modal oculto" id="modal__firma_supervisor">
        <div class="modal__body">
            <div class="modal__body__login">
                <div class="dialog__titulo">
                    <h3>Autorizar</h3>
                    <a href="#" class="close__dialog__confirm" title="cerrar">
                        <svg xmlns="http://www.w3.org/2000/svg" height="32" width="32" class="sin__eventos" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2023 Fonticons, Inc.--><path fill="#e8e8e8" d="M256 48a208 208 0 1 1 0 416 208 208 0 1 1 0-416zm0 464A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM175 175c-9.4 9.4-9.4 24.6 0 33.9l47 47-47 47c-9.4 9.4-9.4 24.6 0 33.9s24.6 9.4 33.9 0l47-47 47 47c9.4 9.4 24.6 9.4 33.9 0s9.4-24.6 0-33.9l-47-47 47-47c9.4-9.4 9.4-24.6 0-33.9s-24.6-9.4-33.9 0l-47 47-47-47c-9.4-9.4-24.6-9.4-33.9 0z"/></svg>
                    </a>
                </div>
                <div class="dialogo__cuerpo_login">
                    <button type="button" class="button__autoriza_supervisor">Autorizar Documento</button>
                    <button type="button" class="button__devuelve_supervisor">Devolver Observado</button>
                </div>
            </div>
        </div>
    </div>
    <div class="modal oculto" id="modal__firma">
        <div class="modal__body">
            <div class="modal__body__login">
                <div class="dialog__titulo">
                    <h3>Autorizar</h3>
                ...
                <div class="dialogo__cuerpo_login">
                    <button type="button" class="button__autoriza_sepcon">Autorizar Documento</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="wrap">
        ...
        <div class="wrap__body">
            <input type="hidden" name="nombre_firma" id="nombre_firma">
            <input type="hidden" name="tipo_firma" id="tipo_firma">
            <input type="hidden" name="documento_firma" id="documento_firma">
    ...
    <script src="js/firma.js?v<?php echo $random; ?>" type="module"></script>
    <script src="js/rubrica.js?v<?php echo $random; ?>"></script>
    <script src="js/rubrica2.js?v<?php echo $random; ?>"></script>
    <script src="js/rubrica3.js?v<?php echo $random; ?>"></script>
</body>
</html>